...
const STAGES = [
  ...
  },
  {
    ...
    ,
      ...
      },
      {
        ...
        deltas: { happiness: 1 },
        result: '이름 석 자 위에, 소속 하나가 더 생겼다는 게 낯설고도 뿌듯했다.'
      },
      {
        id: 'commute-fatigue-24',
        text: '긴 출퇴근 시간에 지쳐간다',
        deltas: { happiness: -1 },
        result: '왕복 몇 시간이, 하루의 절반을 갉아먹는 기분이었다.'
      },
      {
        id: 'first-savings-account-24',
        text: '월급의 일부를 떼어 적금을 시작한다',
        deltas: { wealth: 1 },
        result: '작은 액수였지만, 미래를 위한 첫걸음 같았다.'
      },
      {
  ...
  },
  {
    ...
    ,
      {
        id: 'first-vacation-day-25',
        text: '입사 후 처음으로 연차를 내고 온전히 쉰다',
        deltas: { happiness: 2 },
        result: '아무 일정 없는 하루가, 이렇게 소중한 줄 몰랐다.'
      },
      {
        id: 'budgeting-app-start-25',
        text: '가계부 앱을 깔고 지출을 기록하기 시작한다',
        deltas: { wealth: 1 },
        result: '어디로 새는지 몰랐던 돈의 흐름이, 조금씩 보이기 시작했다.'
      },
      {
        id: 'night-school-english-25',
        text: '퇴근 후 영어 학원에 등록한다',
        deltas: { wealth: -1, fame: 1 },
        result: '피곤한 몸을 이끌고도, 뭔가 쌓이고 있다는 기분이 들었다.'
      },
      {
        id: 'close-friend-moving-away-25',
  ...
  },
  {
    ...
    ,
      {
        id: 'apartment-lease-renewal-29',
        text: '전셋값이 올라 계약 갱신에 애를 먹는다',
        deltas: { wealth: -2, happiness: -1 },
        result: '오른 숫자 하나에, 이사까지 고민해야 했다.'
      },
      {
        id: 'weekend-hiking-hobby-29',
        text: '주말마다 등산을 다니며 체력을 다진다',
        deltas: { health: 2 },
        result: '정상에서 내려다본 풍경이, 한 주의 피로를 씻어줬다.'
      },
      {
        id: 'old-flame-reconnect-29',
        text: '우연히 옛 연인과 다시 연락이 닿는다',
        deltas: { happiness: 1 },
        result: '묻어뒀던 감정이, 예상 못 한 순간에 슬며시 떠올랐다.'
      },
      {
        id: 'career-second-thoughts-29',
        text: '지금 직업이 평생 갈지 다시 한번 되묻는다',
        deltas: { happiness: -1 },
  ...
  },
  {
    ...
    ,
      {
        id: 'child-birth-preparation-32',
        text: '출산을 앞두고 육아용품을 준비한다',
        deltas: { wealth: -2, happiness: 2 },
        result: '작은 옷가지 하나에도, 설렘이 가득 묻어났다.'
      },
      {
        id: 'career-crossroads-32',
        text: '이직할지 그대로 남을지 갈림길에 선다',
        deltas: { happiness: -1 },
        result: '어느 쪽을 골라도, 후회는 조금씩 남을 것 같았다.'
      },
      {
        id: 'weekend-cycling-hobby-32',
        text: '주말마다 자전거를 타며 스트레스를 푼다',
        deltas: { health: 2 },
        result: '페달을 밟는 동안만큼은, 머릿속이 비워졌다.'
      },
      {
        id: 'old-friend-drift-32',
        text: '바빠지면서 오랜 친구와 점점 멀어진다',
        deltas: { happiness: -1, relationship: -1 },
  ...
  },
  {
    ...
    ,
      {
        id: 'home-purchase-search-34',
        text: '내 집 마련을 위해 발품을 팔아 집을 알아본다',
        deltas: { wealth: -1 },
      ...
      },
      {
        ...
        text: '후배들에게 조언을 건네는 역할을 맡는다',
        deltas: { fame: 1, relationship: 1 },
        result: '가르친다기보다, 함께 배우는 기분이었다.'
      },
      {
        id: 'weekend-family-outing-34',
        text: '가족과 함께 근교로 나들이를 떠난다',
        deltas: { happiness: 2 },
  ...
  },
  {
    ...
    ,
      {
        id: 'home-loan-refinance-35',
        text: '더 나은 조건으로 대출을 갈아탄다',
        deltas: { wealth: 2 },
        result: '이자 몇 푼에도, 통장 숨통이 조금 트였다.'
      },
      {
      ...
      },
      {
        ...
        text: '사회생활을 위해 골프 레슨을 시작한다',
        deltas: { wealth: -1, relationship: 1 },
        result: '공보다 사람 사이의 거리를 좁히는 데 더 마음을 썼다.'
      },
      {
        id: 'certification-exam-pass-35',
        text: '오래 준비한 자격증 시험에 합격한다',
        deltas: { wealth: 1, fame: 1 },
        result: '합격 통지 한 줄이, 그간의 밤들을 보상해줬다.'
      },
      {
  ...
  },
  {
    ...
    ,
      {
        id: 'home-renovation-decision-36',
        text: '낡은 신혼집을 새로 꾸미기로 결심한다',
        deltas: { wealth: -2, happiness: 2 },
        result: '먼지 속에서도, 달라질 집을 상상하니 견딜 만했다.'
      },
      {
      ...
      },
      {
        ...
        text: '주말마다 러닝 모임에 나가 땀을 흘린다',
        deltas: { health: 2, happiness: 1 },
        result: '숨이 찰수록, 머릿속은 오히려 맑아졌다.'
      },
      {
        id: 'office-politics-fatigue-36',
        text: '사내 정치에 지쳐 이직을 알아본다',
        deltas: { happiness: -2 },
        result: '능력보다 줄서기가 앞서는 걸 볼 때마다, 마음이 식어갔다.'
      },
      {
        id: 'parenting-book-study-36',
        text: '육아서를 읽으며 부모 역할을 공부한다',
        deltas: { happiness: 1 },
        result: '책 속의 정답이, 현실에선 늘 조금씩 달랐다.'
      },
      {
  ...
  },
  {
    ...
    ,
      {
        id: 'mortgage-stress-37',
        text: '매달 나가는 대출 이자에 마음이 무겁다',
        deltas: { wealth: -1, happiness: -1 },
        result: '월급날마다, 통장을 스쳐 지나가는 돈이 아쉬웠다.'
      },
      {
      ...
      },
      {
        ...
        text: '대학 동기의 성공 소식에 묘한 기분이 든다',
        deltas: { happiness: -1 },
        result: '축하한다는 말 뒤로, 작은 씁쓸함이 따라왔다.'
      },
      {
        id: 'weekend-family-camping-37',
        text: '가족과 함께 캠핑을 떠난다',
        deltas: { happiness: 2, relationship: 1 },
        result: '불멍 앞에 둘러앉은 시간이, 오래 남을 것 같았다.'
      },
      {
  ...
  },
  {
    ...
    ,
      {
        id: 'reading-glasses-first-40',
        text: '처음으로 돋보기안경을 맞춘다',
        deltas: { health: -1 },
        result: '선명해진 글씨만큼, 나이도 선명하게 느껴졌다.'
      },
      {
        id: 'class-reunion-forty-40',
        text: '마흔 기념 동창 모임에 나간다',
        deltas: { happiness: 2, relationship: 1 },
        result: '달라진 얼굴들 속에서도, 그때 그 웃음은 그대로였다.'
      },
      {
  ...
  },
  {
    ...
    ,
      ...
      },
      {
        ...
        text: '주말마다 낚시터를 찾으며 여유를 즐긴다',
        deltas: { happiness: 2 },
        result: '입질이 없어도, 그저 앉아 있는 시간이 좋았다.'
      },
      {
      ...
      },
      {
        ...
        text: '예전 상사에게서 안부 연락을 받는다',
        deltas: { happiness: 1, relationship: 1 },
        result: '잊고 지냈던 인연이, 뜻밖의 반가움으로 다가왔다.'
      },
      {
  ...
  },
  {
    ...
    ,
      ...
      },
      {
        ...
        text: '숙면을 취하지 못하는 날이 늘어간다',
        deltas: { health: -2 },
        result: '뒤척이는 밤이 늘수록, 아침이 점점 무거워졌다.'
      },
      {
        id: 'old-neighborhood-revisit-44',
        text: '오래전 살던 동네를 우연히 다시 찾는다',
        deltas: { happiness: 1 },
        result: '많이 변했지만, 골목 하나에서 옛 기억이 되살아났다.'
      },
      {
        id: 'financial-advisor-consultation-44',
        text: '재무 상담을 받으며 노후 계획을 점검한다',
        deltas: { wealth: 1 },
        result: '막연했던 숫자들이, 조금씩 구체적인 그림으로 바뀌었다.'
      },
      {
  ...
  },
  {
    ...
    ,
      ...
      },
      {
        ...
        text: '건강기능식품을 챙겨 먹기 시작한다',
        deltas: { health: 1, wealth: -1 },
        result: '효과는 몰라도, 챙겨 먹는 것만으로 안심이 됐다.'
      },
      {
        id: 'old-classmate-passes-48',
        text: '동창의 부고 소식에 인생의 무상함을 느낀다',
        deltas: { happiness: -3 },
        result: '같은 교실에 있던 얼굴이, 이제는 사진 속에만 남았다.'
      },
      {
        id: 'weekend-fishing-trip-48',
        text: '주말마다 낚시를 다니며 마음을 비운다',
        deltas: { happiness: 2 },
        result: '물결을 바라보는 것만으로도, 복잡한 마음이 가라앉았다.'
      },
      {
  ...
  },
  {
    ...
    choices: [
...

      {
        ...
        deltas: {"happiness":3,"fame":2},
        result: '후배 정치인들이 조언을 구하러 찾아올 때마다, 세월이 느껴졌다.',
  ...
  },
  {
    ...
    ,
      {
        id: 'cataract-first-symptoms-51',
        text: '눈이 침침해지고 백내장 초기 증상을 느낀다',
        deltas: { health: -1 },
        result: '안개가 낀 듯한 시야가, 자꾸 신경 쓰였다.'
      },
      {
        id: 'retirement-fund-checkup-51',
        text: '은퇴 자금이 충분한지 계산기를 두드려본다',
        deltas: { wealth: 1, happiness: -1 },
        result: '숫자를 맞춰볼수록, 마음은 오히려 복잡해졌다.'
      },
      {
        id: 'old-hobby-revival-51',
        text: '젊은 시절 즐기던 취미를 다시 시작한다',
        deltas: { happiness: 2 },
        result: '손끝이 기억하고 있던 감각이, 반갑게 되살아났다.'
      },
      {
        id: 'sibling-inheritance-tension-51',
        text: '부모님 유산 문제로 형제자매와 갈등을 겪는다',
        deltas: { happiness: -2, relationship: -1 },
        result: '돈 앞에서, 오랜 정도 잠시 흔들렸다.'
      },
      {
  ...
  },
  {
    ...
    ,
      {
        id: 'pre-retirement-anxiety-54',
        text: '다가올 퇴직을 앞두고 밤잠을 설친다',
        deltas: { happiness: -2 },
        result: '정해진 날짜가 다가올수록, 뒤척이는 밤이 늘었다.'
      },
      {
        id: 'health-checkup-scare-54',
        text: '건강검진에서 재검사 통보를 받는다',
        deltas: { health: -1, happiness: -2 },
        result: '별일 아니길 바라며, 다음 병원 예약을 잡았다.'
      },
      {
        id: 'grandchild-first-news-54',
        text: '곧 할머니·할아버지가 된다는 소식을 듣는다',
        deltas: { happiness: 3 },
        result: '믿기지 않는 소식에, 한참을 실감하지 못했다.'
      },
      {
        id: 'downsizing-home-consideration-54',
        text: '넓은 집을 정리하고 작은 집으로 옮길지 고민한다',
        deltas: { wealth: 1 },
        result: '빈 방이 늘수록, 굳이 넓을 필요가 있나 싶었다.'
      },
      {
        id: 'old-mentor-reunion-54',
        text: '오래전 은사님을 다시 찾아뵙는다',
        deltas: { happiness: 2, relationship: 1 },
        result: '세월이 지나도, 가르침의 무게는 그대로였다.'
      },
      {
  ...
  },
  {
    ...
    ,
      ...
      },
      {
        ...
        text: '건강검진에서 주의 소견을 받는다',
        deltas: { health: -1, happiness: -1 },
        result: '괜찮다는 말을 몇 번이나 되뇌었다.'
      },
      {
        id: 'old-house-sale-55',
        text: '오래 살던 집을 정리하고 새로 이사한다',
        deltas: { wealth: 1 },
        result: '정든 벽지를 떠나며, 묘한 아쉬움이 남았다.'
      },
      {
  ...
  },
  {
    ...
    ,
      {
        id: 'part-time-job-search-56',
        text: '새로운 일자리를 알아보러 다닌다',
        deltas: { wealth: 1, happiness: -1 },
      ...
      },
      {
        ...
        text: '오랜만에 고향을 찾아 옛 추억을 더듬는다',
        deltas: { happiness: 2 },
        result: '많이 달라진 풍경 속에서도, 그리움만은 그대로였다.'
      },
      {
  ...
  },
  {
    ...
    ,
      {
        id: 'medical-checkup-anxiety-58',
        text: '건강검진 결과를 기다리며 초조해한다',
        deltas: { happiness: -1 },
        result: '전화벨이 울릴 때마다, 심장이 먼저 반응했다.'
      },
      {
        id: 'travel-bucket-list-58',
        text: '은퇴 후 가보고 싶던 곳들을 목록으로 정리한다',
        deltas: { happiness: 2 },
        result: '적어 내려갈수록, 아직 못 가본 세상이 많다는 게 설렜다.'
      },
      {
        id: 'old-workfriend-reunion-58',
        text: '퇴직한 옛 동료들과 모임을 갖는다',
        deltas: { happiness: 2, relationship: 1 },
        result: '직함을 떼고 만나니, 오히려 더 편한 사이가 됐다.'
      },
      {
        id: 'downsizing-car-58',
        text: '출퇴근이 없어져 차를 작은 걸로 바꾼다',
        deltas: { wealth: 1 },
        result: '필요 없어진 것들을 하나씩 정리하는 재미가 있었다.'
      },
      {
  ...
  },
  {
    ...
    ,
      ...
      },
      {
        ...
        text: '경로 우대 혜택을 처음 받아본다',
        deltas: { happiness: -1 },
        result: '할인 한 번에, 나이를 실감하는 마음이 묘했다.'
      },
      {
        id: 'old-friend-travel-together-61',
        text: '오랜 친구와 함께 여행을 떠난다',
        deltas: { happiness: 2, relationship: 1 },
        result: '말없이 걸어도 편한 사이가, 새삼 고마웠다.'
      },
      {
        id: 'health-supplement-routine-61',
        text: '몸에 좋다는 영양제를 하나둘 챙겨 먹는다',
        deltas: { health: 1, wealth: -1 },
  ...
  },
  {
    ...
    ,
      {
        id: 'full-pension-start-63',
        text: '국민연금을 정식으로 수령하기 시작한다',
        deltas: { wealth: 2, happiness: 1 },
        result: '매달 들어오는 그 돈이, 생각보다 큰 안심을 줬다.'
      },
      {
      ...
      },
      {
        ...
        text: '오랜 친구를 먼저 떠나보낸다',
        deltas: { happiness: -3 },
        result: '함께 나눴던 시간들이, 한꺼번에 밀려왔다.'
      },
      {
        id: 'senior-computer-class-63',
        text: '노인 대상 스마트폰·컴퓨터 강좌에 등록한다',
        deltas: { happiness: 1, fame: 1 },
  ...
  },
  {
    ...
    ,
      {
        id: 'part-time-reentry-64',
        text: '소일거리 삼아 파트타임 일자리를 알아본다',
        deltas: { wealth: 1, happiness: 1 },
        result: '다시 일한다는 감각이, 나쁘지 않게 느껴졌다.'
      },
      {
        id: 'dental-implant-decision-64',
        text: '큰맘 먹고 치아 임플란트 시술을 받는다',
        deltas: { wealth: -2, health: 2 },
        result: '비용은 만만치 않았지만, 씹는 즐거움을 되찾았다.'
      },
      {
        id: 'class-reunion-declining-64',
        text: '동창회 인원이 눈에 띄게 줄어든 걸 실감한다',
        deltas: { happiness: -2 },
        result: '빈자리가 하나둘 늘어가는 걸, 애써 모른 척했다.'
      },
      {
  ...
  },
  {
    ...
    choices: [

      {
        ...
        deltas: {"happiness":3,"wealth":1},
        result: '한 장 한 장 넘길 때마다, 지나온 선거들이 다시 떠올랐다.',
        requiresOccupation: ["local-council-member"]
      },
  ...
  },
  {
    ...
    ,
      ...
      },
      {
        ...
        deltas: { wealth: 1 },
        result: '빠듯해도, 나름의 균형을 찾아갔다.'
      },
      {
        id: 'old-friend-gathering-66',
        text: '동갑내기 친구들과 정기 모임을 갖는다',
        deltas: { happiness: 2, relationship: 1 },
        result: '같은 시대를 산 사람들끼리는, 설명이 필요 없었다.'
      },
      {
        id: 'health-scare-recovery-66',
        text: '건강에 적신호가 왔다 무사히 회복한다',
        deltas: { health: 1, happiness: 1 },
        result: '당연했던 하루가, 얼마나 감사한 일인지 다시 느꼈다.'
      },
      {
  ...
  },
  {
    ...
    ,
      {
        id: 'medication-routine-69',
        text: '매일 챙겨 먹는 약 봉지가 하나둘 늘어난다',
        deltas: { health: 1, happiness: -1 },
        result: '식탁 위 약봉지가, 어느새 하루의 일부가 됐다.'
      },
      {
      ...
      },
      {
        ...
        text: '안 쓰는 물건들을 정리해 기부한다',
        deltas: { happiness: 1 },
        result: '누군가에게는 쓸모가 있을 거라는 생각에, 마음이 가벼워졌다.'
      },
      {
        id: 'spouse-companionship-gratitude-69',
        text: '곁을 지켜준 배우자에게 새삼 고마움을 느낀다',
        deltas: { happiness: 2, relationship: 1 },
        result: '긴 세월, 묵묵히 곁을 지켜준 그 존재가 새삼 크게 느껴졌다.'
      },
      {
        id: 'slower-reading-pace-69',
  ...
  },
  {
    ...
    choices: [

      {
        ...
        deltas: {"happiness":4,"fame":1},
        result: '평생을 바친 지역에서 받는 상이라, 그 무게가 남달랐다.',
        requiresOccupation: ["local-council-member"]
      },
  ...
  },
  {
    ...
    ,
      {
        id: 'hospital-checkup-routine-81',
        text: '정기 검진을 위해 병원을 오간다',
        deltas: { health: 1 },
        result: '번거로워도, 이제는 익숙해진 걸음이었다.'
      },
      {
      ...
      },
      {
        ...
        text: '오래전 받은 편지를 꺼내 다시 읽어본다',
        deltas: { happiness: 2 },
        result: '빛바랜 글씨 속에서, 그 시절 마음이 그대로 느껴졌다.'
      },
      {
        id: 'simplifying-daily-routine-81',
        text: '하루 일과를 최대한 단순하게 줄인다',
        deltas: { happiness: 1 },
        result: '덜어낼수록, 하루가 오히려 편안해졌다.'
      },
      {
        id: 'caregiver-help-acceptance-81',
  ...
  },
  {
    ...
    ,
      ...
      },
      {
        ...
        text: '지팡이를 짚을지 고민하다 받아들인다',
        deltas: { health: 1 },
        result: '자존심보다, 안전이 먼저라는 걸 인정했다.'
      },
      {
        id: 'quiet-morning-routine-82',
        text: '조용한 아침 시간을 소중히 여긴다',
        deltas: { happiness: 1 },
        result: '특별할 것 없는 아침이, 그 자체로 평화로웠다.'
      },
      {
        id: 'family-history-sharing-82',
        text: '자손들에게 집안 이야기를 들려준다',
        deltas: { relationship: 1, happiness: 1 },
    ...
    ,
      {
        ...
        deltas: { health: -2 },
        result: '먹어야 한다는 걸 알면서도, 수저가 쉽게 가지 않았다.'
      },
      {
        id: 'family-reunion-84',
        text: '온 가족이 모이는 자리에서 웃음꽃이 핀다',
        deltas: { happiness: 3 },
        result: '북적이는 소리가, 오랜만에 집안을 가득 채웠다.'
      },
      {
        id: 'old-record-listening-84',
        text: '젊은 시절 즐겨 듣던 음악을 다시 듣는다',
        deltas: { happiness: 1 },
        result: '익숙한 멜로디 하나에, 그 시절이 고스란히 떠올랐다.'
      },
      {
        id: 'quiet-acceptance-84',
        text: '다가올 날들을 담담히 받아들이기로 한다',
        deltas: { happiness: 1 },
  ...
  },
  {
    ...
    ,
      {
        id: 'hearing-decline-86',
        text: '귀가 잘 들리지 않아 대화가 힘들어진다',
        deltas: { health: -1 },
        result: '되묻는 횟수가 늘수록, 미안한 마음도 함께 늘었다.'
      },
      {
        id: 'family-visit-joy-86',
        text: '자손들이 찾아와 온 집안이 북적인다',
        deltas: { happiness: 3 },
        result: '떠들썩한 소리가, 집안 가득 온기를 채웠다.'
      },
      {
        id: 'simple-pleasures-86',
        text: '따뜻한 차 한 잔에서도 작은 행복을 느낀다',
        deltas: { happiness: 1 },
        result: '거창하지 않아도, 충분히 좋은 하루였다.'
      },
      {
        id: 'memory-lapses-86',
        text: '가끔 방금 한 일도 잊어버리는 걸 느낀다',
        deltas: { health: -1 },
  ...
  },
  {
    ...
    ,
      {
        id: 'wheelchair-consideration-88',
        text: '이동에 휠체어를 쓸지 고민한다',
        deltas: { health: -1 },
        result: '받아들이기까지, 마음의 시간이 조금 필요했다.'
      },
      {
        id: 'life-story-recording-88',
        text: '자손들에게 남길 인생 이야기를 녹음해둔다',
        deltas: { happiness: 2 },
        result: '말로 풀어낼수록, 지나온 세월이 더 선명해졌다.'
      },
      {
        id: 'daily-caregiver-visit-88',
        text: '매일 찾아오는 요양보호사와 정이 든다',
        deltas: { happiness: 1, relationship: 1 },
        result: '가족 아닌 사람에게도, 마음을 나눌 수 있다는 걸 알았다.'
      },
      {
        id: 'sunlight-afternoon-nap-88',
        text: '따뜻한 햇볕 아래 낮잠을 즐긴다',
        deltas: { happiness: 1, health: 1 },
        result: '짧은 낮잠 한 번이, 하루의 큰 위안이 됐다.'
      },
      {
  ...
  },
  {
    ...
    ,
      {
        id: 'hearing-aid-consideration-89',
        text: '보청기를 새로 맞출지 고민한다',
        deltas: { health: -1 },
        result: '안 들리는 걸 인정하는 데도, 시간이 필요했다.'
      },
      {
        id: 'old-diary-rereading-89',
        text: '젊은 시절 써둔 일기장을 다시 펼쳐본다',
        deltas: { happiness: 2 },
        result: '삐뚤빼뚤한 글씨 속에, 잊고 있던 내가 있었다.'
      },
      {
        id: 'family-video-call-89',
        text: '타지에 있는 가족과 영상통화로 얼굴을 본다',
        deltas: { happiness: 2, relationship: 1 },
        result: '작은 화면 속 얼굴이, 그리움을 잠시 달래줬다.'
      },
      {
        id: 'slow-meal-savoring-89',
        text: '한 끼 식사를 천천히 오래 음미한다',
        deltas: { happiness: 1 },
        result: '서두를 이유가 없는 식사가, 오히려 더 맛있게 느껴졌다.'
      },
      {
        id: 'quiet-gratitude-for-today-89',
        text: '무사히 하루를 보냈다는 사실에 조용히 감사한다',
        deltas: { happiness: 1 },
...
// 담긴 루트도 추가하고싶어. 이 루트는 나이 기준으로 등장하지 않고 연인이 있을때
// 매년 20%확률로 루트에 진입해") - prison과 같은 원리(PRISON_CHOICES 참고)의
// 전역 풀. 진입 나이가 18~60세 사이 아무 때나 될 수 있어 특정 나이의 choices
// 배열 안에 넣을 수 없다. 진입 자체는 각 나이(18~60세)에 심어둔
// lover-route-attempt-<나이> 트리거가 담당 - requiresAnyLover + mandatory로
// 연인이 있는 한 매년 반드시 노출되고, prizeTable로 20%만 실제 startsRoute가
// 발동한다(나머지 80%는 아무 일도 안 일어나고 다음 해에 다시 시도).
const LOVER_ROUTE_CHOICES = [
  {
    id: 'romance-first-date',
    text: '연인과 처음으로 정식 데이트를 나간다',
    deltas: { happiness: 4, relationship: 2 },
    result: '무슨 옷을 입을지 세 번은 바꿔 입었다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-daily-calls',
    text: '매일 밤 통화하며 하루를 나눈다',
    deltas: { happiness: 2, relationship: 1 },
    result: '별일 없는 하루도, 나누고 나면 특별해졌다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-meet-friends',
    text: '서로의 친구들에게 소개하는 자리를 갖는다',
    deltas: { happiness: 2, relationship: 2 },
    result: '긴장한 티가 역력했지만, 다행히 분위기는 좋았다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-first-trip',
    text: '함께 짧은 여행을 떠난다',
    deltas: { happiness: 4, relationship: 2, wealth: -1 },
    result: '낯선 풍경보다, 옆자리가 더 오래 기억에 남았다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-small-fight',
    text: '사소한 일로 처음 다툰다',
    deltas: { happiness: -2, relationship: -1 },
    result: '별것 아닌 말 한마디가, 생각보다 오래 마음에 남았다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-jealousy-onset',
    text: '상대의 이성 친구 관계에 신경이 쓰이기 시작한다',
    deltas: { happiness: -2 },
    result: '믿는다고 말하면서도, 마음 한구석은 자꾸 삐걱댔다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-makeup-after-fight',
    text: '다툰 뒤 먼저 손을 내밀어 화해한다',
    deltas: { happiness: 3, relationship: 3 },
    result: '먼저 건넨 말 한마디가, 생각보다 어렵지 않았다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-meet-parents',
    text: '상대의 부모님께 처음 인사드린다',
    deltas: { happiness: 3, relationship: 2 },
    result: '차 한잔 마시는 동안, 손에 땀이 흥건했다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-family-disapproval',
    text: '가족이 이 관계를 탐탁지 않아 한다',
    deltas: { happiness: -3, relationship: -1 },
    result: '축복받지 못하는 사랑이라는 게, 이렇게 무거울 줄 몰랐다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-long-distance-strain',
    text: '떨어져 지내는 시간이 길어지며 마음이 지친다',
    deltas: { happiness: -2 },
    result: '화면 너머 얼굴만으로는, 채워지지 않는 게 있었다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-surprise-event',
    text: '깜짝 이벤트를 준비해 상대를 감동시킨다',
    deltas: { happiness: 4, relationship: 3, wealth: -1 },
    result: '준비하는 내내 들킬까 봐 조마조마했다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-financial-disagreement',
    text: '데이트 비용을 두고 은근한 신경전을 벌인다',
    deltas: { happiness: -1, relationship: -1 },
    result: '사랑과 돈은, 생각보다 자주 부딪혔다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-supports-through-hardship',
    text: '힘든 시기를 겪는 상대의 곁을 묵묵히 지킨다',
    deltas: { happiness: 2, relationship: 4 },
    result: '특별한 말보다, 그저 곁에 있는 것이 더 큰 힘이 됐다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-different-life-goals',
    text: '서로 그리는 미래의 모습이 다르다는 걸 깨닫는다',
    deltas: { happiness: -2 },
    result: '같은 곳을 보고 있다고 믿었는데, 조금씩 방향이 갈렸다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-anniversary-celebration',
    text: '만난 지 1년 되는 날을 함께 기념한다',
    deltas: { happiness: 4, relationship: 2 },
    result: '365일이 이렇게 빨리 지나갈 줄 몰랐다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-rival-appears',
    text: '상대에게 관심을 보이는 사람이 나타나 불안해진다',
    deltas: { happiness: -3 },
    result: '질투인지 불안인지 모를 감정이, 자꾸 마음을 흔들었다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-moving-in-together',
    text: '함께 살아보기로 하며 동거를 시작한다',
    deltas: { happiness: 3, relationship: 3, wealth: -2 },
    result: '매일 얼굴을 본다는 게, 설렘과 낯섦을 동시에 안겼다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-habits-friction',
    text: '생활 습관 차이로 자잘한 갈등이 쌓인다',
    deltas: { happiness: -2, relationship: -1 },
    result: '사소한 습관 하나가, 큰 다툼의 씨앗이 될 줄 몰랐다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-career-support',
    text: '상대의 커리어를 위해 기꺼이 희생을 감수한다',
    deltas: { happiness: 1, relationship: 3 },
    result: '미룬 것은 있었지만, 후회는 없었다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-third-party-temptation',
    text: '잠깐의 흔들림을 스스로 다잡는다',
    deltas: { happiness: -1, relationship: 1 },
    result: '마음이 흔들린 순간도 있었지만, 결국 지키기로 했다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-quiet-comfortable',
    text: '말이 없어도 편안한 사이가 됐음을 느낀다',
    deltas: { happiness: 3, relationship: 2 },
    result: '굳이 채우지 않아도 되는 침묵이, 오히려 좋았다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-engagement-talk',
    text: '결혼 이야기가 진지하게 오가기 시작한다',
    deltas: { happiness: 3, relationship: 2 },
    result: '농담처럼 꺼낸 말이, 어느새 진심이 되어 있었다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-proposal',
    text: '긴 고민 끝에 프러포즈를 한다',
    deltas: { happiness: 6, relationship: 4 },
    result: '떨리는 손으로 내민 반지에, 두 사람 다 눈시울이 붉어졌다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-marriage-decision',
    text: '오랜 연애 끝에 결혼을 결심한다',
    deltas: { happiness: 6, relationship: 4 },
    result: '긴 여정 끝에, 마침내 같은 곳을 바라보기로 했다.',
    requiresRoute: 'romance',
    endsRoute: true,
    addFamilyMembers: [{ id: 'spouse', label: '💍 배우자' }]
  },
  {
    id: 'romance-quiet-fade',
    text: '연락이 뜸해지며 관계가 서서히 식어간다',
    deltas: { happiness: -3 },
    result: '누구의 잘못도 아니었지만, 마음은 이미 멀어져 있었다.',
    requiresRoute: 'romance'
  },
  {
    id: 'romance-breakup-mutual',
    text: '서로 다른 길을 가기로 합의하며 이별한다',
    deltas: { happiness: -4, relationship: -3 },
    result: '덤덤하게 나눈 마지막 인사가, 오히려 더 아팠다.',
    requiresRoute: 'romance',
    endsRoute: true,
    removeAcquaintance: { relation: 'lover' }
  },
  {
    id: 'romance-breakup-heartbreak',
    text: '일방적인 이별 통보에 크게 무너진다',
    deltas: { happiness: -6, relationship: -4 },
    result: '예상 못 한 이별 앞에서, 한동안 아무것도 손에 잡히지 않았다.',
    requiresRoute: 'romance',
    endsRoute: true,
    removeAcquaintance: { relation: 'lover' }
  },
  {
    id: 'romance-post-fight-growth',
    text: '큰 다툼을 겪은 뒤 오히려 더 단단해진다',
    deltas: { happiness: 2, relationship: 3 },
    result: '부딪힌 만큼, 서로를 더 깊이 알게 됐다.',
    requiresRoute: 'romance'
  },
];
